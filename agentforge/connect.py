"""Native cognis-connect emit for agentforge — forward findings to any platform.

Maps agentforge's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    agentforge ... --format json | agentforge-emit --to stix
    agentforge-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
